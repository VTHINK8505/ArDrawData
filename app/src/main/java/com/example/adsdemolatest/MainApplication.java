package com.example.adsdemolatest;
...
import com.example.adsdemolatest.Purchase.BillingInitializeClass;
...
public class MainApplication extends Application implements Application.ActivityLifecycleCallbacks, DefaultLifecycleObserver {
    ...
    public void onCreate() {
        ...
        billingInitializeClass = new BillingInitializeClass(MainApplication.this);
    ...
    private class AppOpenAdManager {
        ...
        private void loadAd(Context context) {
            ...
            Log.e("loadAd", "loadAd: " + SplashActivity.getAdsConstant().getOpenAdId());
            isLoadingAd = true;
            AdRequest request = new AdRequest.Builder().build();
            AppOpenAd.load(
                    context,
                    SplashActivity.getAdsConstant().getOpenAdId(),
                    request,
        ...
        private void showAdIfAvailable(
            ...
            if (!isAdAvailable()) {
                ...
                if (!PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString("IABTCF_PurposeConsents", "null").equals("0")) {
                    if (SplashActivity.getAdsConstant() != null) {
                        if (SplashActivity.getAdsConstant().getAdsShowType().equals("1")) {
    ...
    public void clickLogFirebaseEvent(String eventId, String eventName, String clickEvent) {
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, eventId);
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, eventName);
        this.mFirebaseAnalytics.logEvent(clickEvent, bundle);
    }
